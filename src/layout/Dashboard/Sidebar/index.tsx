        ...
        <ul>
          {
            menus1.map((menu, index) => (
              <li>
                <NavLink to={menu.route} activeClassName="selected" className="sidebar-menu-link" key={menu.title}>
                  <div className="sidebar-menu-link-img mr-4">
                    <img src={menu.icon} alt="admoni logo" />
                  </div>  {!showIcon && <div className="sidebar-menu-link-title">{menu.title}</div>}
                </NavLink>
              </li>
            ))
          }
          <li>
            <div className="sidebar-menu-link" onClick={() => setShowDropDown(!showDropDown)}>
              <div className="sidebar-menu-link-img mr-4">
              ...
              <ol className="">
                {menusInner.map((menu, index) => (
                  ...
                  <li>
                    ...
                    <NavLink to={menu.route} activeClassName="selected-inner" className="sidebar-menu-link-inner" key={menu.title + index}>
                      <div className="sidebar-menu-link-img mr-4">
                        <img src={menu.icon} alt="admoni logo" />
                      </div>  {!showIcon && <div className="sidebar-menu-link-title">{menu.title}</div>}
                    </NavLink>
...

          {
            menus2.map((menu, index) => (
              <li>
                <NavLink to={menu.route} activeClassName="selected" className="sidebar-menu-link" key={menu.title + index}>
                  <div className="sidebar-menu-link-img mr-4">
                    <img src={menu.icon} alt="admoni logo" />
                  </div>  {!showIcon && <div className="sidebar-menu-link-title">{menu.title}</div>}
                </NavLink>
