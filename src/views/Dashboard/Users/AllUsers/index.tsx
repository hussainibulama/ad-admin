...
const AllAdmin = () => {
  ...
  const tableHead: { name: keyof TableData; displayName: any }[] = [
    ...
    { name: "action", displayName: <div className="action"> ACTION <div> <img src={caretDown} alt={caretDown} className="ml-2"/></div></div>},
  ];
      ...
      <div className="grid-cont">
        ...
        <div>
         ...
         <div className="sub-grid-cont">
                  ...
                  <div className="calendar"> <img src={Calendar} alt=""  /> </div>
          <div>
